...
cc_s16f FM_Operator_Process(const FM_Operator *fm_operator, const FM_LFO *lfo, cc_u8f amplitude_modulation_sensitivity, cc_u8f phase_modulation_sensitivity, cc_s16f phase_modulation);
