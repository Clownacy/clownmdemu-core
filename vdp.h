...
#define VDP_V30_SCANLINES_IN_TILE_PAIRS 15
#define VDP_V28_SCANLINES_IN_TILE_PAIRS 14
#define VDP_MAX_SCANLINES_IN_TILE_PAIRS CC_MAX(VDP_V30_SCANLINES_IN_TILE_PAIRS, VDP_V28_SCANLINES_IN_TILE_PAIRS)
...
#define VDP_GetScreenHeightInTilePairs(state) ((state)->v30_enabled ? VDP_V30_SCANLINES_IN_TILE_PAIRS : VDP_V28_SCANLINES_IN_TILE_PAIRS)
